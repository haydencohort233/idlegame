...
function Statistics() {
  ...
  const enemyKillCounts = usePlayerStore((state) => state.enemyKillCounts); // Added enemy kill counts
  ...
  return (
    <div className="statistics-container">
      ...
      <ul>
        ...
        <h3>Enemy Kill Statistics</h3>
        <li>Goblin Kills: {enemyKillCounts["goblin"] || 0}</li>
      </ul>
    </div>
  );
}
